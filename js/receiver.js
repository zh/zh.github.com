$(document).ready(function() {
  ...
  var stream = new Pusher("ca98f37ee78bdafdb108", "stream");
  var notice = new Pusher("ca98f37ee78bdafdb108", "notice");
  ...
  stream.bind("irc-bgjap", function(message) {
    ...
    var div = $("<div/>")
      ...
      .append($("<p/>")
              .append($("<img/>")
                      .addClass("icon")
                      .attr({ src: "/img/irc.png", alt: "irc", width: icon_size, height: icon_size }))
              .append($("<span/>")
                      .addClass("screen_name")
                      .text(nick + ":"))
              .append(format(text)));
